        ...
        <InsertItemTemplate>
            ...
            <table>
                ...
                <tr>
                    <td>Assigned to:</td>
                    <td>
                        <asp:TextBox ID="assigned_toTextBox" runat="server" Text='<%# Bind("assigned_to") %>' CssClass="form-control" />
                    </td>
                    <td>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="assigned_toTextBox" CssClass="text-danger" ErrorMessage="Required Field." ForeColor="Red" /></td>
                </tr>
                ...
                <tr>
                    <td>Project:</td>
                    <td>
                        <asp:TextBox ID="projectTextBox" runat="server" Text='<%# Bind("project") %>' CssClass="form-control" />
                    </td>
                </tr>
                <tr>
                    <td>Status:</td>
